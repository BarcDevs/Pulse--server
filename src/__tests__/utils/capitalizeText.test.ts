...
describe('capitalizeText utility', () => {
    ...
    it('should return empty string for null-like input', () => {
        const result = capitalizeText(null as unknown as string)

        expect(result).toBe('')
    })

    it('should return empty string for undefined input', () => {
        const result = capitalizeText(undefined as unknown as string)
    ...
    it('should only capitalize first letter of all uppercase word', () => {
        const result = capitalizeText('HELLO')

        expect(result).toBe('HELLO')
    })

    it('should capitalize first letter of mixed case word', () => {
        const result = capitalizeText('hELLO')
