...
describe('Cache Middleware', () => {
    describe('cacheMiddleware', () => {
        ...
        it(
            'should skip caching for PUT requests',
            () => {
                const req = createMockRequest({
                    method: 'PUT',
        ...
        it(
            'should skip caching for DELETE requests',
            () => {
                const req = createMockRequest({
                    method: 'DELETE',
                    originalUrl: '/api/v1/posts/123'
        ...
        it(
            'should pass through for GET request on cache miss',
            () => {
                const req = createMockRequest({
                    method: 'GET',
        ...
        it(
            'should wrap res.send for GET requests',
            () => {
                const req = createMockRequest({
                    method: 'GET',
        ...
        it(
            'should use originalUrl as cache key',
            () => {
                const req = createMockRequest({
                    method: 'GET',
        ...
        it(
            'should differentiate cache keys by query params',
            () => {
